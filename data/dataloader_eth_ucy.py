...
class ETHDataset(object):
    def __init__(self, cfg, training=True, data_dir = None, subset = None, rotate_time_frame=0, imle=False, type='original'): # type='original' / 'LED'
        ...
        if type == 'LED':
            ...
            all_data = np.load(data_file_path) # (9874,1,20,2)
            all_num = np.load(num_file_path) # (9874,)
